(ns fulcro.fulcro-native-expo-substitute
  "Copied from https://github.com/SignSpice/fulcro-real-world/blob/master/src/main/app/fulcro_native_expo_substitute.cljc"
  (:require
    #?@(:cljs [["expo" :as expo]
